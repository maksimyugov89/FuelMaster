...
Реклама и AI-советы: в текущей версии приложения не используются и запросы
к ним не отправляются. Яндекс Мобильная Реклама, подписка и сервис AI-советов
появятся в будущих версиях — тогда этот раздел будет обновлён.
''';
...
2. Аккаунт нужен для синхронизации истории между устройствами и для
   подтверждения e-mail. Вы отвечаете за сохранность пароля.
3. Подписка, реклама и AI-советы в текущей версии недоступны и появятся
   в будущих обновлениях; условия будут обновлены вместе с ними.
